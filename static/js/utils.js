...
function evidenceLabel(value) {
  ...
  const labels = {
    ...
    "auth.login_success_after_failures": "login after failures",
    "security.exposure_with_auth_failures": "exposure + auth failures",
    "security.high_risk_wan_exposure": "high-risk WAN exposure",
    "network.dhcp_ip_conflict": "DHCP IP conflict",
